...
Begin VB.UserControl ctlFileBrowser 
   ...
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   445
   Begin prjdocCER.chameleonButton cmdBrowse 
      Height          =   375
      Left            =   4800
      TabIndex        =   2
      Top             =   0
...
Private Sub UserControl_ReadProperties(PropBag As PropertyBag)
    ...
    cdlFile.FileName = PropBag.ReadProperty("File", "")
...
Private Sub UserControl_WriteProperties(PropBag As PropertyBag)
    ...
    Call PropBag.WriteProperty("File", cdlFile.FileName, "")
